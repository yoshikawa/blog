...
M1 の夏に，[サマーインターンに参加](https://yoshikawa.dev/cyberagent-intern)しました．

ありがたいことに，AbemaTV で働かせていただきました．

インターンを経験しましたが，エントリーシートを書き，エンジニアと 2 回話し，人事と 1 回話しました．
...
M1 の夏に，[Sansan のインターンで姓名分割](https://yoshikawa.dev/sansan-intern)をしました．
...
[2020 年サマーインターンの選考結果](https://yoshikawa.dev/2020-internship)にも書きましたが，Yahoo! Japan のサマーインターンは落ちました．
...
M1 の 11 月に，[ZOZO テクノロジーズのインターンでリファクタリング支援ツール作成](https://yoshikawa.dev/zozo-intern)をしていました．
...
M1 の夏に，[マネーフォワードのインターンでコンテナイメージ脆弱性検査](https://yoshikawa.dev/moneyforward-intern)をしました．
